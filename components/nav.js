  ...
  function render() {
    ...
    nav.innerHTML =
      ...
      '<div class="nav-resume-group">' +
        ...
        '<a href="https://drive.google.com/file/d/1FJDZI8xlQgeWfl7zgbS3LjaTYYZJbWh3/view" target="_blank" rel="noopener" class="nav-resume-label nav-resume-link">PDF</a>' +
        '<a href="resume.md" target="_blank" rel="noopener" class="nav-resume-label nav-resume-link">MD</a>' +
      '</div>';
